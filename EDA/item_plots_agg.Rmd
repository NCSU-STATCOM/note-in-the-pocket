...
Note that the red vertical line marks the COVID starting date, the green areas the spring semester and the brown areas the fall semester. The blue curves are the fitted curves with respect to the number of requests for the female and male items. 
...
# School times
school2018_s <- lubridate::as_date(c("2019-01-15", "2019-06-11"))
...
load("D:/GitHub/note-in-the-pocket/orders_filled_forecasting/orders_female_np.RData")
load("D:/GitHub/note-in-the-pocket/orders_filled_forecasting/orders_male_np.RData")
