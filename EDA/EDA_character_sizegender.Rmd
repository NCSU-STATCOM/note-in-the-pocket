...
#Change as need be
#orddf <- readRDS("~/STATCOM/NoteInThePocket/orders_allyears_df.rds")
```

\textbf{Count of Orders for Gender, Size by POC:}

```{r echo=FALSE, warning=FALSE}
poc_dem<-orddf%>%group_by(POC)%>%
  summarise(fem_s=length(female_small[female_small==T]),
            fem_l=length(female_large[female_large==T]),
            male_s=length(male_small[male_small==T]),
            male_l=length(male_large[male_large==T]))
...
poc_dem[1:10,]%>%gather(key,val,-POC)%>%ggplot(aes(POC,val,fill=key))+
  geom_col(position = "dodge2")+xlab("POC")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size by POC")+
...
\textbf{Count of Orders for Gender, Size by School:}
...
school_dem[1:10,]%>%gather(key,val,-School)%>%ggplot(aes(School,val,fill=key))+
  geom_col(position = "dodge2")+xlab("School")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size by School")+
  scale_fill_discrete(name = "Key", labels = c("Fem Large", "Fem Small", 
                                               "Male Large", "Male Small"))+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5))+
...
\textbf{Count of Orders for Gender, Size by Organization:}
...
org_dem[1:10,]%>%gather(key,val,-Organization)%>%ggplot(aes(Organization,val,fill=key))+
  geom_col(position = "dodge2")+xlab("Organization")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size by Organization")+
  scale_fill_discrete(name = "Key", labels = c("Fem Large", "Fem Small", 
                                               "Male Large", "Male Small"))+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5))+
...
\textbf{Count of Orders for Gender, Size by ZipCode:}
...
zip_dem[1:10,]%>%gather(key,val,-Zip)%>%ggplot(aes(Zip,val,fill=key))+
  geom_col(position = "dodge2")+xlab("ZipCode")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size for ZipCode")+
  scale_fill_discrete(name = "Key", labels = c("Fem Large", "Fem Small", 
                                               "Male Large", "Male Small"))+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5))+
...
\textbf{Count of Orders for Gender, Size by Adult v Non-Adult:}
...
ad_dem%>%gather(key,val,-adult)%>%ggplot(aes(adult,val,fill=key))+
  geom_col(position = "dodge2")+xlab("Adult(1) v Non-Adult(0)")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size for Adult v Non-Adult")+
  scale_fill_discrete(name = "Key", labels = c("Fem Large", "Fem Small", 
                                               "Male Large", "Male Small"))+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5))+
...
\textbf{Count of Orders for Gender, Size by Student v Non-Student:}
...
stu_dem%>%gather(key,val,-StudentInd)%>%ggplot(aes(StudentInd,val,fill=key))+
  geom_col(position = "dodge2")+xlab("Student(1) v Non-Student(0)")+ylab("Number of Orders")+
  ggtitle("Number of Orders Per Gender and Size for Student v Non-Student")+
  scale_fill_discrete(name = "Key", labels = c("Fem Large", "Fem Small", 
                                               "Male Large", "Male Small"))+
  coord_flip()+
  theme(plot.title = element_text(hjust = 0.5))+
